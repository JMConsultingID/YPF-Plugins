    ...
    <form action='options.php' method='post'>
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                ...
                <td>
                    Use Shortcode <code>[ypf-pricing-table productid="23" format="tab" ypf-step-table="step_1:_fx_challenge, step_2:_inspection_period, etc"]</code><br/> using button <code>[ypf-pricing-table productid="23" ypf-step-table="step_1:_fx_challenge, step_2:_inspection_period, etc" free_trial_btn="無料体験" challenge_begins_btn="チャレンジ開始"]</code><br/>
