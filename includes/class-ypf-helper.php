...
function display_acf_group_labels_and_tooltips_el($group_field_name, $tooltips_field_name, $product_id, $tooltips_post_id) {
    ...
    if ($group_field_object) {
        ...
        foreach ($group_field_object['sub_fields'] as $index => $sub_field) {
            ...
            echo '<div class="pt__row heading-vertical ' . esc_html($sub_field_name) . ' ypf_side_title_bg_elementor ypf_side_title_text_elementor pt__table_general_border_color"><div class="pt__row-heading-text">' . esc_html($sub_field_label) . $sub_field_tooltip_text . '</div></div>'; 
        }
...
function display_acf_group_fields_el($group_field_name, $product_id, $css_class_prefix) {
    ...
    if ($group_field_values && $group_field_object) {
        ...
        foreach ($group_field_object['sub_fields'] as $sub_field) {
            ...
            echo '<div class="pt__row ' . esc_attr($css_class_prefix) . ' val val-' . esc_attr($sub_field_name) . ' ' . $additional_class . ' pt__table_general_border_color">' . $sub_field_value . '</div>';
